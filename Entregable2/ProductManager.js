...
//     console.log('TEST: updateProducts() [Actualización del título y el id de un producto existente]...');
//     console.log(instanceManager.updateProduct(1,{title:"título Modificado", id:9}));   
    
//     // console.log('TEST: updateProducts() [Actualización del título de un producto que no existe]...');
//     // console.log(instanceManager.updateProduct(8,{title:"título Modificado"}));   
    
//     console.log('TEST: getProducts() [Con un producto modificado]...');
//     console.log(instanceManager.getProducts());

//     console.log('TEST: addProduct() [Pasando un nuevo producto]...\n');
//     console.log(instanceManager.addProduct(productData));    
    
//     console.log('TEST: getProducts() [Con dos productos]...');
//     console.log(instanceManager.getProducts());

//     console.log('TEST: deleteProducts() [Borrando el producto con ID=2]...');
//     console.log(instanceManager.deleteProduct(2)); 

//     console.log('TEST: getProducts() [Luego de borrar el ID2]...');
//     console.log(instanceManager.getProducts());

//     // console.log('TEST: deleteProducts() [Borrando el producto con ID=2 que ya no existe]...');
//     // console.log(instanceManager.getProducts(2));
